...
struct WritingView: View {
    ...
    private func checkAnswer() {
        ...
        print("✏️ Answer check: isWordComplete=\(isWordComplete) isGameOver=\(isGameOver) answersMatch=\(answersMatch)")
        ...
        if answersMatch {
            print("✏️ CORRECT ANSWER - awarding XP")
            correctAnswers += 1
            ...
            print("✏️ Correct answer! Session XP: \(sessionXP)")
